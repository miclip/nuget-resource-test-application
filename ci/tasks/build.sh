...
dotnet pack-ext simple ./src/TestApplication/TestApplication.csproj 
 --version-spec "1.0.0" --basepath ./src/TestApplication/publish --no-publish --no-build --source ./output . https://www.myget.org/F/dotnet-resource-test/api/v3/index.json`
